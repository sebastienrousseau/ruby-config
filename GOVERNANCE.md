...
This document describes how @sebastienrousseau/ruby-config is run: who decides what, how
...
@sebastienrousseau/ruby-config is **maintainer-led**. As of the current release line it has a single
