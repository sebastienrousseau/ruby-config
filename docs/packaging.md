...
# Packaging @sebastienrousseau/ruby-config
...
-  `.rubocop.yml`, `standard.yml` — the tool-native preset file(s)
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/ruby-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/ruby-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/ruby-config/` |
| Homebrew | [`pkg/brew/ruby-config.rb`](../pkg/brew/ruby-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/ruby-config/` |
