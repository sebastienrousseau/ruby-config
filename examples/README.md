# `@sebastienrousseau/ruby-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/ruby-config`.
...
- [x] **.rubocop.yml**: Standardized rule preset
- [x] **standard.yml**: Standardized rule preset
